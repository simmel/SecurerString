...
public class FoundInHeap {
  @After public void foundInHeap() throws IOException, InterruptedException, XPathExpressionException {
    ...
    try {
      ...
      assertEquals("Secret not found!", 2, nodeList.getLength());
    }
    finally {
